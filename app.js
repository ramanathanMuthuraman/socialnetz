...
var fb = (function () {
    ...
    /**
     * Initialize the fb module. You must use this function and initialize the module with an appId before you can
    ...
    /**
     * Checks if the user has logged in with fb and currently has a session api token.
